...
const descriptor: Tool = {
  type: 'function',
  function: {
    name: 'jscad-render-perspective',
    description: 'Render JSCAD to a PNG perspective snapshot and return a PNG data URL when possible.',
    parameters: {
      type: 'object',
      required: ['file'],
      properties: {
...
export const jscadRenderPerspectiveTool: ToolDefinition = {
  descriptor,
  run,
};
